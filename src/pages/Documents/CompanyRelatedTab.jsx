...
import { Business, Description, HelpOutline, CheckCircle, CloudUpload } from '@mui/icons-material';
...
function CompanyRelatedTab({ category, formData, handleFileChange, newFiles }) {
    ...
    const documentLabels = category.documents.map(doc => ({
        ...
        fullName: doc,
        instruction: {
            'Signed Offer Letter / Appointment Letter': 'Upload your signed offer letter or appointment letter from the company (PDF, JPG, or PNG).',
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="caption" sx={{ color: '#64748b' }}>
                            Upload company-related onboarding documents
                        </Typography>
                    </Box>
                </Box>
