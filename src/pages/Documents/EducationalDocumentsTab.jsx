...
import { School, Description, HelpOutline } from '@mui/icons-material';
...
function EducationalDocumentsTab({ category, formData, handleFileChange, newFiles }) {
    ...
    const documentLabels = category.documents.map(doc => ({
        ...
        instruction: {
            'High School Certificate': 'Upload a clear scan or photo of your High School Certificate (PDF, JPG, or PNG).',
            'Bachelor Degree': 'Upload your Bachelor Degree certificate (PDF or image).',
            'Master Degree': 'Upload your Master Degree certificate (PDF or image).',
            'Transcript': 'Upload your academic transcript (PDF only).',
