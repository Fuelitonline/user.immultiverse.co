...
import { Work, Description, HelpOutline } from '@mui/icons-material';
...
function PreviousEmploymentTab({ category, formData, handleFileChange, newFiles }) {
    ...
    const documentLabels = category.documents.map(doc => ({
        ...
        instruction: {
            'Experience Letter': 'Upload a clear scan or photo of your Experience Letter (PDF, JPG, or PNG).',
            'Offer Letter': 'Upload your Offer Letter from your previous employer (PDF or image).',
            'Payslip': 'Upload a recent payslip (PDF or image).',
            'Relieving Letter': 'Upload your Relieving Letter from your previous employer (PDF only).',
        ...
        <Fade in={true} timeout={800}>
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2.5 }}>
                    <Work sx={{ color: theme.palette.primary.main, fontSize: 30 }} />
                    <Typography 
                        variant="h5" 
                        sx={{ 
