...
import { Work, Description, HelpOutline, CheckCircle, CloudUpload } from '@mui/icons-material';

function PreviousEmploymentTab({ category, formData, handleFileChange, newFiles }) {
    ...
    const documentLabels = category.documents.map(doc => ({
        ...
        fullName: doc,
        instruction: {
            'Experience Letter / Relieving Letter': 'Upload your experience letter or relieving letter from previous employer (PDF, JPG, or PNG).',
            "Last 3 Months' Salary Slips": "Upload your last 3 months' salary slips from previous employer (PDF, JPG, or PNG).",
    ...
    return (
        <Fade in={true} timeout={800} sx={{width: '100%'}}>
            <Paper 
                elevation={0}
                sx={{
                    p: 4,
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
                    <Box sx={{ 
                        ...
                        <Work sx={{ color: '#2563eb', fontSize: 28 }} />
                    </Box>
                    <Box>
                        <Typography 
                            variant="h5" 
                        ...
                        <Typography variant="caption" sx={{ color: '#64748b' }}>
                            Upload previous employment verification documents
                        </Typography>
                    </Box>
                </Box>
