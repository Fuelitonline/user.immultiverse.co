...
import { Person, Description, HelpOutline, CheckCircle, CloudUpload } from '@mui/icons-material';

function IdentityBankTab({ category, formData, handleFileChange, newFiles }) {
    ...
    const documentLabels = category.documents.map(doc => ({
        ...
        fullName: doc,
        instruction: {
            'Aadhaar Card': 'Upload a clear scan or photo of your Aadhaar Card (PDF, JPG, or PNG).',
            'PAN Card': 'Upload a valid PAN Card image or PDF.',
            'Passport': 'Upload the first page of your Passport (PDF or image).',
            'Driving License': 'Upload a clear image or PDF of your Driving License.',
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
                    <Box sx={{ 
                        ...
                        {React.cloneElement(category.icon, { sx: { color: '#2563eb', fontSize: 28 } })}
                    </Box>
                    <Box>
                        <Typography 
                            variant="h5" 
...
export default IdentityBankTab;